...
Простий і зручний імпортер CSV-файлів для Jigoshop.
1. Імпортуйте сотні або тисячі товарів одночасно.
2. Імпортуйте зображення за URL-адресою або локальним шляхом до файлу. (Тепер виявляє і пропускає дублікати зображень!)
3. Імпорт ієрархічних структур категорій.
4. Імпорт тегів.
5. Опис імпорту.
6. Імпортувати ціну.
